...
> 当前副本已将前端迁移为 React + Ant Design + TypeScript，并提供面向个人服务器的 Docker Compose 部署。迁移说明见 [README_REACT_MIGRATION.md](./README_REACT_MIGRATION.md)，部署步骤见 [DEPLOY_PERSONAL_SERVER.md](./DEPLOY_PERSONAL_SERVER.md)。
